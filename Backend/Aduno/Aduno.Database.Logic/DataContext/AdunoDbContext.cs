...
namespace Aduno.Database.Logic.DataContext
{
    internal class AdunoDbContext : DbContext
    {
        ...
        //private static string ConnectStr => "User ID=aduno;Password=bb$3O1QM;Host=student.cloud.htl-leonding.ac.at/s.rausch-schott/postgres;Port=80;Database=aduno;";
