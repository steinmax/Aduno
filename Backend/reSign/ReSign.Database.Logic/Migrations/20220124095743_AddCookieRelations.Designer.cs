...
namespace ReSign.Database.Logic.Migrations
{
    ...
    [Migration("20220124095743_AddCookieRelations")]
    partial class AddCookieRelations
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReSign.Database.Data.Entities.PresenceSystem.QRSessionCookie", b =>
                {
                    b.HasOne("ReSign.Database.Data.Entities.General.Display", "Display")
                        .WithMany()
                        .HasForeignKey("DisplayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ReSign.Database.Data.Entities.PresenceSystem.Device", "UsedByDevice")
                        .WithMany()
                        .HasForeignKey("UsedByDeviceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
